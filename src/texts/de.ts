export const DE_TEXTS = {
    ...
    queryModalEmptyTip: 'KI-gestützte Q&A auf Basis deiner Wiki-Wissensdatenbank',
    queryModalEmptyGreet: 'Hallo, ich bin dein Tianzhi-KI-Assistent',
    queryModalEmptyIntro: 'Stelle Fragen zu deinem Wiki. Klicke auf „Im Wiki speichern", um wertvolle Antworten als Wiki-Seiten zu archivieren.',
    ...
    // Seitenleiste (ItemView-Tabs)
    cmdOpenSidebar: 'Tianzhi-Seitenleiste öffnen',
    cmdNewChat: 'Neue Konversation',
    sidebarTitle: 'Tianzhi Wiki',
    tabChat: 'Chat',
    tabSync: 'Wissenssync',
    syncPanelIngestSection: 'Aufnehmen',
    syncPanelIngestFile: 'Datei aufnehmen',
    syncPanelIngestFolder: 'Ordner aufnehmen',
    syncPanelIngestActive: 'Aktuelle Datei aufnehmen',
    syncPanelMaintainSection: 'Wartung',
    syncPanelLint: 'Wiki-Lint ausführen',
    syncPanelSuggestSchema: 'Schema-Aktualisierungen vorschlagen',
    syncPanelIndexSection: 'Index',
    syncPanelRegenerateIndex: 'Index neu generieren',
    syncPanelEnsureStructure: 'Wiki-Struktur initialisieren',
    syncPanelCancel: 'Aktuelle Operation abbrechen',
    ...
    // Authentifizierung (Tianzhi Cloud-Anmeldung)
    authLoginTitle: 'Bei Tianzhi Cloud anmelden',
    authLoginDesc: 'Melde dich an, um Notizen mit der Cloud-Wissensdatenbank zu synchronisieren und KI-Fragen zu aktivieren.',
    authLoginButton: 'Anmelden',
    authLoginButtonLoading: 'Anmeldung läuft…',
    authLoginButtonRetry: 'Erneut anmelden',
    authLoginOpeningWindow: 'Anmeldefenster wird geöffnet…',
    authLoginFailed: 'Anmeldung fehlgeschlagen: {}',
    authLoginSuccess: 'Bei Tianzhi Cloud angemeldet',
    authLoginRequired: 'Bitte melden Sie sich zuerst bei Tianzhi Cloud an, um zu synchronisieren',
    authLogout: 'Abmelden',
    authLogoutLoading: 'Abmeldung läuft…',
    authLogoutSuccess: 'Von Tianzhi Cloud abgemeldet',
    authLogoutFailed: 'Abmeldung fehlgeschlagen',
    syncStatusTitle: 'Sync-Status',
    syncStatusIdle: 'Nicht synchronisiert',
    syncStatusSyncing: 'Wird synchronisiert',
    syncStatusCompleted: 'Sync abgeschlossen ({} hochgeladen, {} übersprungen, {} fehlgeschlagen)',
    syncStatusError: 'Synchronisierung fehlgeschlagen',
    syncNowButton: 'Jetzt synchronisieren',
    syncAllUpToDate: 'Alles ist bereits auf dem neuesten Stand',
    syncKbCardTitle: 'Tianzhi Wissensdatenbank',
    syncHint: 'Notizen werden automatisch mit der Tianzhi-Wissensdatenbank synchronisiert und bei Bedarf neu erstellt.',
    syncToggleAutoSync: 'Wissenssynchronisierung',
    syncAutoSyncDesc: 'Inkrementelle Synchronisierung — scannt und lädt geänderte Dateien nur hoch, wenn der Computer im Leerlauf ist',
    syncProgressTemplate: 'Synchronisiere: {}',
    syncPhaseEnumerating: 'Lokale Dateien werden aufgelistet…',
    syncPhaseCreatingKb: 'Wissensdatenbank wird gesucht/erstellt…',
    syncPhaseListingDocs: 'Vergleich mit Remote-Dokumentliste…',
    syncPhaseUploading: 'Lade {} hoch',
    syncErrorKbCreate: 'Wissensdatenbank konnte nicht erstellt werden: {}',
    syncErrorListDocs: 'Remote-Dokumentliste fehlgeschlagen: {}',
    syncErrorUpload: 'Upload fehlgeschlagen: {}',
    syncErrorFileTooLarge: 'Datei zu groß (>{ }MB), übersprungen: {}',
    syncErrorUnauthorized: 'Bitte zuerst bei Tianzhi Cloud anmelden',
    syncAutoSyncIntervalHint: 'Bei aktivem Schalter stündliche automatische Synchronisierung',
    ...
    // 天智大模型 Auto-Anmeldung
    cosmoSection: 'Tianzhi-LLM Schnellanmeldung',
    cosmoSectionDescLogin: 'Nicht bei Tianzhi Cloud angemeldet. Klicken Sie unten auf "Anmelden". Das Plugin tauscht automatisch Ihre Mitarbeiternummer gegen einen API-Schlüssel und konfiguriert das Modell.',
    cosmoSectionDescReady: 'Über IAM angemeldet. API-Schlüssel, Base-URL und Standardmodell wurden automatisch konfiguriert.',
    cosmoStatusName: 'IAM-Status',
    cosmoStatusReady: '✅ Angemeldet (Mitarbeiternummer {}) — Plugin bereit',
    cosmoStatusNotReady: '⚠️ Nicht angemeldet oder keine employee_code verfügbar',
    cosmoFetchKeySuccess: '✅ 天智大模型 automatisch konfiguriert (Standardmodell: {model})',
    cosmoFetchKeyFailed: '❌ 天智大模型-Auto-Konfiguration fehlgeschlagen: {}',
