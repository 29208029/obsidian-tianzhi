export const EN_TEXTS = {
    ...
    queryModalEmptyTip: 'AI-powered Q&A based on your Wiki knowledge base',
    queryModalEmptyGreet: "Hi, I'm your Tianzhi AI assistant",
    queryModalEmptyIntro: 'Ask anything about your Wiki. Click "Save to Wiki" to turn valuable answers into permanent Wiki pages.',
    ...
    // Sidebar (ItemView tabs)
    cmdOpenSidebar: 'Open tianzhi sidebar',
    cmdNewChat: 'New conversation',
    sidebarTitle: 'Tianzhi Wiki',
    tabChat: 'Chat',
    tabSync: 'Knowledge Sync',
    syncPanelIngestSection: 'Ingest',
    syncPanelIngestFile: 'Ingest a file',
    syncPanelIngestFolder: 'Ingest a folder',
    syncPanelIngestActive: 'Ingest current file',
    syncPanelMaintainSection: 'Maintain',
    syncPanelLint: 'Run Wiki lint',
    syncPanelSuggestSchema: 'Suggest Schema updates',
    syncPanelIndexSection: 'Index',
    syncPanelRegenerateIndex: 'Regenerate index',
    syncPanelEnsureStructure: 'Initialize Wiki structure',
    syncPanelCancel: 'Cancel current operation',

    // Maintain Wiki tab (sidebar)
    ...
    // Auth (tianzhi cloud login)
    authLoginTitle: 'Sign in to Tianzhi Cloud',
    authLoginDesc: 'Sign in to sync notes to the cloud knowledge base and enable AI Q&A.',
    authLoginButton: 'Sign in',
    authLoginButtonLoading: 'Signing in…',
    authLoginButtonRetry: 'Retry sign in',
    authLoginOpeningWindow: 'Opening sign-in window…',
    authLoginFailed: 'Sign in failed: {}',
    authLoginSuccess: 'Signed in to Tianzhi Cloud',
    authLoginRequired: 'Please sign in to Tianzhi Cloud before syncing',
    authLogout: 'Sign out',
    authLogoutLoading: 'Signing out…',
    authLogoutSuccess: 'Signed out from Tianzhi Cloud',
    authLogoutFailed: 'Sign out failed',
    syncStatusTitle: 'Sync status',
    syncStatusIdle: 'Not synced',
    syncStatusSyncing: 'Syncing',
    syncStatusCompleted: 'Done ({} uploaded, {} skipped, {} failed)',
    syncStatusError: 'Sync failed',
    syncNowButton: 'Sync now',
    syncAllUpToDate: 'Everything is already up to date',
    syncKbCardTitle: 'Tianzhi Knowledge Base',
    syncHint: 'Notes sync automatically to the Tianzhi knowledge base; new ones are auto-created.',
    syncToggleAutoSync: 'Auto knowledge sync',
    syncAutoSyncDesc: 'Incremental sync — only scans and uploads changed files when your computer is idle',
    syncProgressTemplate: 'Syncing: {}',
    syncPhaseEnumerating: 'Enumerating local files…',
    syncPhaseCreatingKb: 'Finding/creating knowledge base…',
    syncPhaseListingDocs: 'Comparing remote document list…',
    syncPhaseUploading: 'Uploading {}',
    syncErrorKbCreate: 'Knowledge base create failed: {}',
    syncErrorListDocs: 'Remote doc list failed: {}',
    syncErrorUpload: 'Upload failed: {}',
    syncErrorFileTooLarge: 'File too large (>{}MB), skipped: {}',
    syncErrorUnauthorized: 'Please sign in to Tianzhi Cloud first',
    syncAutoSyncIntervalHint: 'Triggers automatically every hour when on',
    ...
    // Source-analyzer hardcoded English → i18n
    ...
    // Wiki-engine onProgress messages
    wikiAnalyzing: 'Analyzing: {}',
    wikiCreatingSummary: 'Creating summary…',
    wikiEntityOrConcept: '{}: {}',  // "Entity"/"Concept" label concat
    ...
    // Tianzhi LLM auto-login
    cosmoSection: 'Tianzhi LLM Quick Login',
    cosmoSectionDescLogin: 'Not signed in to Tianzhi Cloud. Click "Sign In" below — the plugin will automatically exchange your employee code for an API key and configure the model.',
    cosmoSectionDescReady: 'Signed in via IAM. API key, base URL and default model have been auto-configured.',
    cosmoStatusName: 'IAM Status',
    cosmoStatusReady: '✅ Signed in (employee code {}) — plugin ready',
    cosmoStatusNotReady: '⚠️ Not signed in or no employee_code available',
    cosmoFetchKeySuccess: '✅ Tianzhi LLM auto-configured (default model: {model})',
    cosmoFetchKeyFailed: '❌ Tianzhi LLM auto-configuration failed: {}',
