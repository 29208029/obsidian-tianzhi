export const ES_TEXTS = {
    ...
    queryModalEmptyTip: 'Preguntas y respuestas con IA basadas en tu Wiki',
    queryModalEmptyGreet: 'Hola, soy tu asistente de IA Tianzhi',
    queryModalEmptyIntro: 'Pregunta lo que quieras sobre tu Wiki. Pulsa «Guardar en Wiki» para convertir respuestas valiosas en páginas Wiki permanentes.',
    ...
    // Barra lateral (pestañas ItemView)
    cmdOpenSidebar: 'Abrir barra lateral Tianzhi',
    cmdNewChat: 'Nueva conversación',
    sidebarTitle: 'Tianzhi Wiki',
    tabChat: 'Chat',
    tabSync: 'Sincronización de conocimiento',
    syncPanelIngestSection: 'Ingerir',
    syncPanelIngestFile: 'Ingerir un archivo',
    syncPanelIngestFolder: 'Ingerir una carpeta',
    syncPanelIngestActive: 'Ingerir archivo actual',
    syncPanelMaintainSection: 'Mantener',
    syncPanelLint: 'Ejecutar lint del Wiki',
    syncPanelSuggestSchema: 'Sugerir actualizaciones del esquema',
    syncPanelIndexSection: 'Índice',
    syncPanelRegenerateIndex: 'Regenerar índice',
    syncPanelEnsureStructure: 'Inicializar estructura del Wiki',
    syncPanelCancel: 'Cancelar operación actual',
    ...
    // Autenticación (inicio de sesión Tianzhi Cloud)
    authLoginTitle: 'Iniciar sesión en Tianzhi Cloud',
    authLoginDesc: 'Inicia sesión para sincronizar notas con la base de conocimiento en la nube y activar Q&A de IA.',
    authLoginButton: 'Iniciar sesión',
    authLoginButtonLoading: 'Iniciando sesión…',
    authLoginButtonRetry: 'Reintentar',
    authLoginOpeningWindow: 'Abriendo ventana de inicio de sesión…',
    authLoginFailed: 'Error de inicio de sesión: {}',
    authLoginSuccess: 'Sesión iniciada en Tianzhi Cloud',
    authLoginRequired: 'Inicia sesión en Tianzhi Cloud antes de sincronizar',
    authLogout: 'Cerrar sesión',
    authLogoutLoading: 'Cerrando sesión…',
    authLogoutSuccess: 'Sesión cerrada en Tianzhi Cloud',
    authLogoutFailed: 'Error al cerrar sesión',
    syncStatusTitle: 'Estado de sincronización',
    syncStatusIdle: 'No sincronizado',
    syncStatusSyncing: 'Sincronizando',
    syncStatusCompleted: 'Sincronización completa ({} subidos, {} omitidos, {} fallidos)',
    syncStatusError: 'Error de sincronización',
    syncNowButton: 'Sincronizar ahora',
    syncAllUpToDate: 'Todo está actualizado',
    syncKbCardTitle: 'Base de conocimiento Tianzhi',
    syncHint: 'Las notas se sincronizan automáticamente con la base Tianzhi; si no existen se crean.',
    syncToggleAutoSync: 'Sincronización automática de conocimiento',
    syncAutoSyncDesc: 'Sincronización incremental — solo escanea y sube los archivos modificados cuando el equipo está inactivo',
    syncProgressTemplate: 'Sincronizando: {}',
    syncPhaseEnumerating: 'Enumerando archivos locales…',
    syncPhaseCreatingKb: 'Buscando/creando base de conocimiento…',
    syncPhaseListingDocs: 'Comparando con lista remota…',
    syncPhaseUploading: 'Subiendo {}',
    syncErrorKbCreate: 'Error al crear la base: {}',
    syncErrorListDocs: 'Error al obtener lista remota: {}',
    syncErrorUpload: 'Error al subir: {}',
    syncErrorFileTooLarge: 'Archivo demasiado grande (>{ }MB), omitido: {}',
    syncErrorUnauthorized: 'Inicia sesión primero en Tianzhi Cloud',
    syncAutoSyncIntervalHint: 'Con el interruptor activado, se ejecuta automáticamente cada hora',
    ...
    // 天智大模型 Inicio de sesión automático
    cosmoSection: 'Inicio rápido Tianzhi LLM',
    cosmoSectionDescLogin: 'Sin sesión en Tianzhi Cloud. Haz clic en "Iniciar sesión" abajo — el plugin intercambiará automáticamente tu número de empleado por una clave API y configurará el modelo.',
    cosmoSectionDescReady: 'Sesión iniciada vía IAM. Clave API, URL base y modelo predeterminado se configuraron automáticamente.',
    cosmoStatusName: 'Estado IAM',
    cosmoStatusReady: '✅ Sesión iniciada (número de empleado {}) — plugin listo',
    cosmoStatusNotReady: '⚠️ Sin sesión o sin employee_code disponible',
    cosmoFetchKeySuccess: '✅ 天智大模型 configurado automáticamente (modelo predeterminado: {model})',
    cosmoFetchKeyFailed: '❌ Fallo en la configuración automática de 天智大模型: {}',
