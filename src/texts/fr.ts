export const FR_TEXTS = {
    ...
    queryModalEmptyTip: 'Q&R alimentées par l’IA à partir de votre Wiki',
    queryModalEmptyGreet: 'Bonjour, je suis votre assistant IA Tianzhi',
    queryModalEmptyIntro: 'Posez vos questions sur votre Wiki. Cliquez sur « Enregistrer dans le wiki » pour transformer les réponses utiles en pages Wiki.',
    ...
    // Barre latérale (onglets ItemView)
    cmdOpenSidebar: 'Ouvrir la barre latérale Tianzhi',
    cmdNewChat: 'Nouvelle conversation',
    sidebarTitle: 'Tianzhi Wiki',
    tabChat: 'Chat',
    tabSync: 'Sync des connaissances',
    syncPanelIngestSection: 'Importer',
    syncPanelIngestFile: 'Importer un fichier',
    syncPanelIngestFolder: 'Importer un dossier',
    syncPanelIngestActive: 'Ingérer le fichier actif',
    syncPanelMaintainSection: 'Maintenance',
    syncPanelLint: 'Lancer le lint du Wiki',
    syncPanelSuggestSchema: 'Suggérer des mises à jour du schéma',
    syncPanelIndexSection: 'Index',
    syncPanelRegenerateIndex: "Régénérer l'index",
    syncPanelEnsureStructure: 'Initialiser la structure du Wiki',
    syncPanelCancel: "Annuler l'opération en cours",

    // TODO(i18n): translate the following maintainPanel* keys (English fallback below)
    tabMaintain: 'Maintain Wiki',
    maintainPanelTooltipIngestSource: 'Pick a Markdown file from the vault and ingest it into the Wiki.',
    maintainPanelTooltipIngestFolder: 'Pick a folder; every Markdown file inside will be ingested into the Wiki.',
    maintainPanelTooltipIngestActive: 'Ingest the currently open Markdown file into the Wiki.',
    maintainPanelTooltipLint: 'Run a lint pass over the Wiki and report issues.',
    maintainPanelTooltipSuggestSchema: 'Ask the LLM to suggest updates to the Wiki schema based on ingested content.',
    maintainPanelTooltipRegenerateIndex: 'Rebuild the Wiki index from the current engine state.',
    maintainPanelTooltipEnsureStructure: 'Create the Wiki folders and base files if they don\'t yet exist.',
    maintainPanelTooltipCancel: 'Cancel the currently running ingestion or lint operation.',
    maintainPanelReasonNeedLLMConfig: 'LLM is not configured. Open Settings to configure it.',
    maintainPanelReasonNeedActiveFile: 'No file is currently open in the editor.',
    maintainPanelReasonNeedMarkdownFile: 'The active file must be a Markdown file (.md).',
    maintainPanelReasonNothingToCancel: 'No ingestion or lint is currently running.',

    // Authentification (connexion Tianzhi Cloud)
    authLoginTitle: 'Se connecter à Tianzhi Cloud',
    authLoginDesc: 'Connectez-vous pour synchroniser les notes vers la base de connaissances cloud et activer le Q&R IA.',
    authLoginButton: 'Connexion',
    authLoginButtonLoading: 'Connexion…',
    authLoginButtonRetry: 'Réessayer',
    authLoginOpeningWindow: 'Ouverture de la fenêtre de connexion…',
    authLoginFailed: 'Échec de la connexion : {}',
    authLoginSuccess: 'Connecté à Tianzhi Cloud',
    authLoginRequired: "Veuillez vous connecter à Tianzhi Cloud avant de synchroniser",
    authLogout: 'Déconnexion',
    authLogoutLoading: 'Déconnexion…',
    authLogoutSuccess: 'Déconnecté de Tianzhi Cloud',
    authLogoutFailed: 'Échec de la déconnexion',
    syncStatusTitle: 'État de synchronisation',
    syncStatusIdle: 'Non synchronisé',
    syncStatusSyncing: 'Synchronisation',
    syncStatusCompleted: 'Sync terminée ({} envoyés, {} ignorés, {} échoués)',
    syncStatusError: 'Échec de la synchronisation',
    syncNowButton: 'Synchroniser maintenant',
    syncAllUpToDate: 'Tout est déjà à jour',
    syncKbCardTitle: 'Base de connaissances Tianzhi',
    syncHint: 'Les notes sont synchronisées automatiquement avec la base Tianzhi, ou créées si absentes.',
    syncToggleAutoSync: 'Synchronisation automatique des connaissances',
    syncAutoSyncDesc: 'Synchronisation incrémentielle — analyse et envoie uniquement les fichiers modifiés lorsque l\'ordinateur est inactif',
    syncProgressTemplate: 'Synchronisation : {}',
    syncPhaseEnumerating: 'Énumération des fichiers locaux…',
    syncPhaseCreatingKb: 'Recherche/création de la base de connaissances…',
    syncPhaseListingDocs: 'Comparaison avec la liste distante…',
    syncPhaseUploading: 'Envoi de {}',
    syncErrorKbCreate: 'Échec de création de la base : {}',
    syncErrorListDocs: 'Échec de la liste distante : {}',
    syncErrorUpload: 'Échec de l\'envoi : {}',
    syncErrorFileTooLarge: 'Fichier trop volumineux (>{ }Mo), ignoré : {}',
    syncErrorUnauthorized: 'Veuillez d\'abord vous connecter à Tianzhi Cloud',
    syncAutoSyncIntervalHint: 'Synchronisation automatique toutes les heures lorsqu\'activé',
    ...
    sourceAnalyzingBatch: 'Analyzing batch {current} / {total}…',
    sourceAnalyzingBatchContinuing: 'Analyzing batch {current} / {total} ({entities} entities, {concepts} concepts so far)…',
    sourceAnalyzedBatch: 'Analyzed batch {current}, processing…',
    ...
    convSavingEntity: 'Saving entity: {}',
    convSavingConcept: 'Saving concept: {}',
    convGeneratingIndex: 'Generating index…',
    wikiAnalyzing: 'Analyzing: {}',
    wikiCreatingSummary: 'Creating summary…',
    wikiEntityOrConcept: '{}: {}',
    wikiEntityLabel: 'Entity',
    wikiConceptLabel: 'Concept',
    wikiUpdating: 'Updating: {}',
    wikiGeneratingIndex: 'Generating index…',
    wikiProgressStep: '[{current}/{total}] {}',
    lintSmartFixPhasePolluted: 'Smart fix: Phase -1 — Fixing polluted pages…',
    lintSmartFixPhaseAliases: 'Smart fix: Phase 0 — Completing aliases…',
    lintSmartFixPhaseMerge: 'Smart fix: Phase 1 — Merging duplicates…',
    lintSmartFixPhaseDeadLinks: 'Smart fix: Phase 2 — Fixing dead links…',
    lintSmartFixPhaseOrphans: 'Smart fix: Phase 3 — Linking orphan pages…',
    lintSmartFixPhaseEmpty: 'Smart fix: Phase 4 — Expanding empty pages…',
    lintSmartFixPhaseRetag: 'Smart fix: Phase 5 — Retagging out-of-vocabulary tag pages…',
    lintDuplicateCheckLayer3: 'Layer 3 (LLM verify)',
    mainIngestingFile: 'Ingesting: {}',
    mainCheckingAlreadyIngested: 'Checking for already-ingested files…',
    mainIngestingProgress: '[{current}/{total}] {}',
    ...
    lintReportSummary: "Aperçu de l'état du wiki : {total} pages au total, {aliasesMissing} pages sans alias, {duplicates} pages dupliquées, {deadLinks} liens cassés ({deadLinkFromDup} impliquent des doublons), {orphans} pages orphelines ({orphanFromDup} sont des doublons), {emptyPages} pages vides. Durée du lint : {elapsedSeconds}s",
    ...
    // 天智大模型 Connexion automatique
    cosmoSection: 'Connexion rapide Tianzhi LLM',
    cosmoSectionDescLogin: 'Non connecté à Tianzhi Cloud. Cliquez sur « Se connecter » ci-dessous — le plugin échangera automatiquement votre matricule contre une clé API et configurera le modèle.',
    cosmoSectionDescReady: 'Connecté via IAM. Clé API, URL de base et modèle par défaut ont été configurés automatiquement.',
    cosmoStatusName: 'Statut IAM',
    cosmoStatusReady: '✅ Connecté (matricule {}) — plugin prêt',
    cosmoStatusNotReady: '⚠️ Non connecté ou employee_code indisponible',
    cosmoFetchKeySuccess: '✅ 天智大模型 configuré automatiquement (modèle par défaut : {model})',
    cosmoFetchKeyFailed: '❌ Échec de la configuration automatique 天智大模型 : {}',
    cosmoDefaultModel: 'COSMO-Mind-think',
} as const;
