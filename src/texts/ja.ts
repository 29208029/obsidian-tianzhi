export const JA_TEXTS = {
    ...
    queryModalEmptyTip: 'Wiki ナレッジベースで AI による質疑応答',
    queryModalEmptyGreet: 'こんにちは、天智 AI アシスタントです',
    queryModalEmptyIntro: 'Wiki ナレッジベースにもとづいて質問に答えます。「Wiki に保存」をクリックすると、有益な回答を Wiki ページとして保存できます。',
    ...
    // サイドバー（ItemView タブ）
    cmdOpenSidebar: '天智サイドバーを開く',
    cmdNewChat: '新しい会話',
    sidebarTitle: '天智 Wiki',
    tabChat: '会話',
    tabSync: 'ナレッジ同期',
    syncPanelIngestSection: '取り込み',
    syncPanelIngestFile: 'ファイルを取り込む',
    syncPanelIngestFolder: 'フォルダーを取り込む',
    syncPanelIngestActive: '現在のファイルを取り込む',
    syncPanelMaintainSection: 'メンテナンス',
    syncPanelLint: 'Wiki Lint を実行',
    syncPanelSuggestSchema: 'スキーマ更新を提案',
    syncPanelIndexSection: 'インデックス',
    syncPanelRegenerateIndex: 'インデックスを再生成',
    syncPanelEnsureStructure: 'Wiki 構造を初期化',
    syncPanelCancel: '現在の操作をキャンセル',
    ...
    // 認証（Tianzhi Cloud ログイン）
    authLoginTitle: 'Tianzhi Cloud にサインイン',
    authLoginDesc: 'サインインするとノートがクラウド知識ベースに同期され、AI Q&A が有効になります。',
    authLoginButton: 'サインイン',
    authLoginButtonLoading: 'サインイン中…',
    authLoginButtonRetry: '再サインイン',
    authLoginOpeningWindow: 'サインインウィンドウを開いています…',
    authLoginFailed: 'サインイン失敗：{}',
    authLoginSuccess: 'Tianzhi Cloud にサインインしました',
    authLoginRequired: '同期する前に Tianzhi Cloud にサインインしてください',
    authLogout: 'サインアウト',
    authLogoutLoading: 'サインアウト中…',
    authLogoutSuccess: 'Tianzhi Cloud からサインアウトしました',
    authLogoutFailed: 'サインアウト失敗',
    syncStatusTitle: '同期ステータス',
    syncStatusIdle: '未同期',
    syncStatusSyncing: '同期中',
    syncStatusCompleted: '同期完了（{} 件アップロード、{} 件スキップ、{} 件失敗）',
    syncStatusError: '同期失敗',
    syncNowButton: '今すぐ同期',
    syncAllUpToDate: 'すべて同期済みです',
    syncKbCardTitle: 'Tianzhi ナレッジベース',
    syncHint: 'ノートは Tianzhi 知識ベースに自動同期され、存在しない場合は自動作成されます。',
    syncToggleAutoSync: 'ナレッジ自動同期',
    syncAutoSyncDesc: '差分同期 — コンピュータがアイドル時に変更ファイルのみをスキャンしてアップロード',
    syncProgressTemplate: '同期中：{}',
    syncPhaseEnumerating: 'ローカルファイルを列挙中…',
    syncPhaseCreatingKb: 'ナレッジベースを検索/作成中…',
    syncPhaseListingDocs: 'リモート文書リストと比較中…',
    syncPhaseUploading: '{} をアップロード中',
    syncErrorKbCreate: 'ナレッジベースの作成に失敗：{}',
    syncErrorListDocs: 'リモート文書リストの取得に失敗：{}',
    syncErrorUpload: 'アップロードに失敗：{}',
    syncErrorFileTooLarge: 'ファイルが大きすぎます（>{}MB）、スキップしました：{}',
    syncErrorUnauthorized: 'まず Tianzhi Cloud にサインインしてください',
    syncAutoSyncIntervalHint: 'オンのとき 1 時間ごとに自動実行',
    ...
    // 天智大模型 自動ログイン
    cosmoSection: '天智大モデル クイックログイン',
    cosmoSectionDescLogin: '天智クラウドにログインしていません。下の「ログイン」をクリックしてください。プラグインが自動で社員番号を API キーに交換し、モデルを設定します。',
    cosmoSectionDescReady: 'IAM 経由でログイン済み。API キー、Base URL、デフォルトモデルは自動設定済みです。',
    cosmoStatusName: 'IAM 状態',
    cosmoStatusReady: '✅ ログイン済み（社員番号 {}）— プラグイン準備完了',
    cosmoStatusNotReady: '⚠️ 未ログイン、または employee_code が取得できません',
    cosmoFetchKeySuccess: '✅ 天智大モデル自動設定完了（デフォルトモデル：{model}）',
    cosmoFetchKeyFailed: '❌ 天智大モデル自動設定失敗：{}',
