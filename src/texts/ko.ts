export const KO_TEXTS = {
    ...
    queryModalEmptyTip: 'Wiki 지식 베이스 기반 AI 질의응답',
    queryModalEmptyGreet: '안녕하세요, 천즈 AI 어시스턴트입니다',
    queryModalEmptyIntro: 'Wiki 지식 베이스를 바탕으로 질문에 답합니다. "Wiki에 저장"을 클릭하면 유용한 답변을 Wiki 페이지로 보관할 수 있습니다.',
    ...
    // 사이드바 (ItemView 탭)
    cmdOpenSidebar: '천지 사이드바 열기',
    cmdNewChat: '새 대화',
    sidebarTitle: '천지 Wiki',
    tabChat: '대화',
    tabSync: '지식 동기화',
    syncPanelIngestSection: '수집',
    syncPanelIngestFile: '파일 수집',
    syncPanelIngestFolder: '폴더 수집',
    syncPanelIngestActive: '현재 파일 수집',
    syncPanelMaintainSection: '유지보수',
    syncPanelLint: 'Wiki 린트 실행',
    syncPanelSuggestSchema: '스키마 업데이트 제안',
    syncPanelIndexSection: '인덱스',
    syncPanelRegenerateIndex: '인덱스 재생성',
    syncPanelEnsureStructure: 'Wiki 구조 초기화',
    syncPanelCancel: '현재 작업 취소',
    ...
    // 인증 (Tianzhi Cloud 로그인)
    authLoginTitle: 'Tianzhi Cloud 로그인',
    authLoginDesc: '로그인하면 노트가 클라우드 지식 베이스에 동기화되고 AI Q&A가 활성화됩니다.',
    authLoginButton: '로그인',
    authLoginButtonLoading: '로그인 중…',
    authLoginButtonRetry: '다시 로그인',
    authLoginOpeningWindow: '로그인 창을 여는 중…',
    authLoginFailed: '로그인 실패: {}',
    authLoginSuccess: 'Tianzhi Cloud에 로그인했습니다',
    authLoginRequired: '동기화하기 전에 먼저 Tianzhi Cloud에 로그인하세요',
    authLogout: '로그아웃',
    authLogoutLoading: '로그아웃 중…',
    authLogoutSuccess: 'Tianzhi Cloud에서 로그아웃했습니다',
    authLogoutFailed: '로그아웃 실패',
    syncStatusTitle: '동기화 상태',
    syncStatusIdle: '동기화되지 않음',
    syncStatusSyncing: '동기화 중',
    syncStatusCompleted: '동기화 완료 ({} 업로드, {} 건너뜀, {} 실패)',
    syncStatusError: '동기화 실패',
    syncNowButton: '지금 동기화',
    syncAllUpToDate: '모든 항목이 이미 동기화되어 있습니다',
    syncKbCardTitle: 'Tianzhi 지식 베이스',
    syncHint: '노트가 Tianzhi 지식 베이스에 자동 동기화되며, 없으면 자동 생성됩니다.',
    syncToggleAutoSync: '지식 자동 동기화',
    syncAutoSyncDesc: '증분 동기화 — 컴퓨터가 유휴 상태일 때 변경된 파일만 스캔하여 업로드',
    syncProgressTemplate: '동기화 중: {}',
    syncPhaseEnumerating: '로컬 파일 열거 중…',
    syncPhaseCreatingKb: '지식 베이스 검색/생성 중…',
    syncPhaseListingDocs: '원격 문서 목록과 비교 중…',
    syncPhaseUploading: '{} 업로드 중',
    syncErrorKbCreate: '지식 베이스 생성 실패: {}',
    syncErrorListDocs: '원격 문서 목록 가져오기 실패: {}',
    syncErrorUpload: '업로드 실패: {}',
    syncErrorFileTooLarge: '파일이 너무 큽니다 (>{ }MB), 건너뜀: {}',
    syncErrorUnauthorized: '먼저 Tianzhi Cloud에 로그인하세요',
    syncAutoSyncIntervalHint: '켜져 있을 때 1시간마다 자동 실행',
    ...
    // 天智大模型 자동 로그인
    cosmoSection: '天智大模型 퀵 로그인',
    cosmoSectionDescLogin: '天智云에 로그인하지 않았습니다. 아래 "로그인"을 클릭하세요. 플러그인이 자동으로 사원번호를 API Key로 교환하고 모델을 설정합니다.',
    cosmoSectionDescReady: 'IAM을 통해 로그인됨. API Key, Base URL, 기본 모델이 자동 설정되었습니다.',
    cosmoStatusName: 'IAM 상태',
    cosmoStatusReady: '✅ 로그인됨 (사원번호 {}) — 플러그인 준비 완료',
    cosmoStatusNotReady: '⚠️ 미로그인 또는 employee_code 없음',
    cosmoFetchKeySuccess: '✅ 天智大模型 자동 설정 완료 (기본 모델: {model})',
    cosmoFetchKeyFailed: '❌ 天智大模型 자동 설정 실패: {}',
