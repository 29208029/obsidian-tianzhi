export const PT_TEXTS = {
    ...
    queryModalEmptyTip: 'Perguntas e respostas com IA a partir do seu Wiki',
    queryModalEmptyGreet: 'Olá, eu sou o seu assistente IA Tianzhi',
    queryModalEmptyIntro: 'Faça perguntas sobre o seu Wiki. Clique em "Salvar na Wiki" para transformar respostas valiosas em páginas Wiki permanentes.',
    ...
    // Barra lateral (abas ItemView)
    cmdOpenSidebar: 'Abrir barra lateral Tianzhi',
    cmdNewChat: 'Nova conversa',
    sidebarTitle: 'Tianzhi Wiki',
    tabChat: 'Chat',
    tabSync: 'Sincronização de conhecimento',
    syncPanelIngestSection: 'Ingerir',
    syncPanelIngestFile: 'Ingerir um arquivo',
    syncPanelIngestFolder: 'Ingerir uma pasta',
    syncPanelIngestActive: 'Ingerir arquivo atual',
    syncPanelMaintainSection: 'Manutenção',
    syncPanelLint: 'Executar lint do Wiki',
    syncPanelSuggestSchema: 'Sugerir atualizações de Schema',
    syncPanelIndexSection: 'Índice',
    syncPanelRegenerateIndex: 'Regenerar índice',
    syncPanelEnsureStructure: 'Inicializar estrutura do Wiki',
    syncPanelCancel: 'Cancelar operação atual',
    ...
    // Autenticação (login Tianzhi Cloud)
    authLoginTitle: 'Entrar no Tianzhi Cloud',
    authLoginDesc: 'Faça login para sincronizar notas com a base de conhecimento na nuvem e ativar Q&A com IA.',
    authLoginButton: 'Entrar',
    authLoginButtonLoading: 'Entrando…',
    authLoginButtonRetry: 'Tentar novamente',
    authLoginOpeningWindow: 'Abrindo janela de login…',
    authLoginFailed: 'Falha no login: {}',
    authLoginSuccess: 'Conectado ao Tianzhi Cloud',
    authLoginRequired: 'Faça login no Tianzhi Cloud antes de sincronizar',
    authLogout: 'Sair',
    authLogoutLoading: 'Saindo…',
    authLogoutSuccess: 'Desconectado do Tianzhi Cloud',
    authLogoutFailed: 'Falha ao sair',
    syncStatusTitle: 'Estado da sincronização',
    syncStatusIdle: 'Não sincronizado',
    syncStatusSyncing: 'Sincronizando',
    syncStatusCompleted: 'Sincronização concluída ({} enviados, {} ignorados, {} falharam)',
    syncStatusError: 'Falha na sincronização',
    syncNowButton: 'Sincronizar agora',
    syncAllUpToDate: 'Tudo já está atualizado',
    syncKbCardTitle: 'Base de conhecimento Tianzhi',
    syncHint: 'As notas são sincronizadas automaticamente com a base Tianzhi; ausentes são criadas.',
    syncToggleAutoSync: 'Sincronização automática de conhecimento',
    syncAutoSyncDesc: 'Sincronização incremental — apenas escaneia e envia arquivos alterados quando o computador está ocioso',
    syncProgressTemplate: 'Sincronizando: {}',
    syncPhaseEnumerating: 'Enumerando arquivos locais…',
    syncPhaseCreatingKb: 'Buscando/criando base de conhecimento…',
    syncPhaseListingDocs: 'Comparando com a lista remota…',
    syncPhaseUploading: 'Enviando {}',
    syncErrorKbCreate: 'Falha ao criar a base: {}',
    syncErrorListDocs: 'Falha ao obter lista remota: {}',
    syncErrorUpload: 'Falha no envio: {}',
    syncErrorFileTooLarge: 'Arquivo grande demais (>{ }MB), ignorado: {}',
    syncErrorUnauthorized: 'Faça login no Tianzhi Cloud primeiro',
    syncAutoSyncIntervalHint: 'Com o interruptor ligado, executa automaticamente a cada hora',
    ...
    // 天智大模型 Login automático
    cosmoSection: 'Login rápido Tianzhi LLM',
    cosmoSectionDescLogin: 'Sem sessão na Tianzhi Cloud. Clique em "Entrar" abaixo — o plugin trocará automaticamente seu número de funcionário por uma chave API e configurará o modelo.',
    cosmoSectionDescReady: 'Sessão iniciada via IAM. Chave API, URL base e modelo padrão foram configurados automaticamente.',
    cosmoStatusName: 'Estado IAM',
    cosmoStatusReady: '✅ Sessão iniciada (número de funcionário {}) — plugin pronto',
    cosmoStatusNotReady: '⚠️ Sem sessão ou employee_code indisponível',
    cosmoFetchKeySuccess: '✅ 天智大模型 configurado automaticamente (modelo padrão: {model})',
    cosmoFetchKeyFailed: '❌ Falha na configuração automática do 天智大模型: {}',
