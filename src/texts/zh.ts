export const ZH_TEXTS = {
    ...
    queryModalEmptyTip: '基于 Wiki 知识库进行智能问答',
    queryModalEmptyGreet: '你好，我是天智大模型助手',
    queryModalEmptyIntro: '基于 Wiki 知识库为你提供智能问答。点击「保存到 Wiki」可将有价值对话提炼为 Wiki 页面。',
    ...
    // 侧边栏（ItemView Tab）
    cmdOpenSidebar: '打开天智侧边栏',
    cmdNewChat: '新建对话',
    sidebarTitle: '天智 Wiki',
    tabChat: '对话',
    tabSync: '知识同步',
    syncPanelIngestSection: '摄取',
    syncPanelIngestFile: '摄取单个文件',
    syncPanelIngestFolder: '摄取文件夹',
    syncPanelIngestActive: '摄取当前笔记',
    syncPanelMaintainSection: '维护',
    syncPanelLint: '运行 Wiki 维护',
    syncPanelSuggestSchema: '建议 Schema 更新',
    syncPanelIndexSection: '索引',
    syncPanelRegenerateIndex: '重建索引',
    syncPanelEnsureStructure: '初始化 Wiki 目录',
    syncPanelCancel: '取消当前操作',

    // 维护 Wiki Tab（侧栏）
    tabMaintain: '维护 Wiki',
    maintainPanelTooltipIngestSource: '从库中选取一个 Markdown 文件并提取到 Wiki。',
    maintainPanelTooltipIngestFolder: '选取文件夹；其中每个 Markdown 文件都会被提取到 Wiki。',
    maintainPanelTooltipIngestActive: '将当前打开的 Markdown 文件提取到 Wiki。',
    maintainPanelTooltipLint: '对 Wiki 运行一次维护检查并报告问题。',
    maintainPanelTooltipSuggestSchema: '让 LLM 根据已提取内容建议 Wiki schema 更新。',
    maintainPanelTooltipRegenerateIndex: '从当前引擎状态重建 Wiki 索引。',
    maintainPanelTooltipEnsureStructure: '若 Wiki 目录与基础文件尚不存在，则创建它们。',
    maintainPanelTooltipCancel: '取消当前正在运行的提取或维护操作。',
    maintainPanelReasonNeedLLMConfig: 'LLM 尚未配置。请打开设置进行配置。',
    maintainPanelReasonNeedActiveFile: '当前编辑器中未打开任何文件。',
    maintainPanelReasonNeedMarkdownFile: '当前文件必须是 Markdown 文件（.md）。',
    maintainPanelReasonNothingToCancel: '当前没有正在运行的提取或维护。',

    // 鉴权（天智云登录）
    authLoginTitle: '登录天智大模型',
    authLoginDesc: '登录后将笔记自动同步到云端知识库，实现 AI 智能问答。',
    authLoginButton: '登录',
    authLoginButtonLoading: '登录中…',
    authLoginButtonRetry: '重新登录',
    authLoginOpeningWindow: '正在打开登录窗口…',
    authLoginFailed: '登录失败：{}',
    authLoginSuccess: '天智云登录成功',
    authLoginRequired: '请先登录天智云后再同步',
    authLogout: '退出登录',
    authLogoutLoading: '退出中…',
    authLogoutSuccess: '已退出天智云登录',
    authLogoutFailed: '退出登录失败',
    syncStatusTitle: '同步状态',
    syncStatusIdle: '未同步',
    syncStatusSyncing: '同步中',
    syncStatusCompleted: '同步完成（{} 个已上传，{} 个跳过，{} 个失败）',
    syncStatusError: '同步失败',
    syncNowButton: '立即同步',
    syncAllUpToDate: '已全部同步',
    syncKbCardTitle: '天智大模型知识库',
    syncHint: '笔记将自动同步到天智大模型知识库，若不存在则自动创建。',
    syncToggleAutoSync: '知识自动同步',
    syncAutoSyncDesc: '增量同步，仅在计算机空闲时扫描并上传变更文件',
    syncProgressTemplate: '正在同步：{}',
    syncPhaseEnumerating: '正在枚举本地文件…',
    syncPhaseCreatingKb: '正在查找/创建知识库…',
    syncPhaseListingDocs: '正在比对远端文件清单…',
    syncPhaseUploading: '正在上传 {}',
    syncErrorKbCreate: '创建知识库失败：{}',
    syncErrorListDocs: '获取远端文件清单失败：{}',
    syncErrorUpload: '上传失败：{}',
    syncErrorFileTooLarge: '文件过大（>{}MB），已跳过：{}',
    syncErrorUnauthorized: '请先登录天智云',
    syncAutoSyncIntervalHint: '开启后每小时自动同步一次',

    // Ingestion status bar
    ingestionStatusBar: '提取中... 点击取消',
    lintStatusBar: '维护中... 点击取消',
    ingestStatusAnalyzing: '提取中… (点击取消)',
    sourceAnalyzingBatch: '正在分析第 {current} / {total} 批…',
    sourceAnalyzingBatchContinuing: '正在分析第 {current} / {total} 批（已提取 {entities} 个实体、{concepts} 个概念）…',
    sourceAnalyzedBatch: '已分析第 {current} 批，正在处理…',

    // Source-analyzer hardcoded English → i18n (issue: zh mode showing English)
    convAnalyzing: '正在分析对话…',
    convCheckingExisting: '正在检查已有知识…',
    convAlreadyExists: '此知识已存在于 Wiki',
    convCreatingSummary: '正在创建摘要页面…',
    convGeneratingSummary: '正在生成摘要页面…',
    convSavingEntity: '正在保存实体：{}',
    convSavingConcept: '正在保存概念：{}',
    convGeneratingIndex: '正在生成索引…',

    // Wiki-engine onProgress messages
    wikiAnalyzing: '正在分析：{}',
    wikiCreatingSummary: '正在创建摘要…',
    wikiEntityOrConcept: '{}：{}',  // "实体"/"概念" 标签拼接
    wikiEntityLabel: '实体',
    wikiConceptLabel: '概念',
    wikiUpdating: '正在更新：{}',
    wikiGeneratingIndex: '正在生成索引…',
    wikiProgressStep: '[{current}/{total}] {}',

    // Lint smart-fix phases
    lintSmartFixPhasePolluted: '智能修复：阶段 -1 — 正在修复污染页面…',
    lintSmartFixPhaseAliases: '智能修复：阶段 0 — 正在补全别名…',
    lintSmartFixPhaseMerge: '智能修复：阶段 1 — 正在合并重复…',
    lintSmartFixPhaseDeadLinks: '智能修复：阶段 2 — 正在修复断链…',
    lintSmartFixPhaseOrphans: '智能修复：阶段 3 — 正在链接孤立页面…',
    lintSmartFixPhaseEmpty: '智能修复：阶段 4 — 正在扩充空洞页面…',
    lintSmartFixPhaseRetag: '智能修复：阶段 5 — 正在重新标记无效标签…',
    lintDuplicateCheckLayer3: 'Layer 3 (LLM verify)',

    // Main.ts showProgress messages
    mainIngestingFile: '正在摄入：{}',
    mainCheckingAlreadyIngested: '正在检查已摄入文件…',
    ...
    // 天智大模型 自动登录
    cosmoSection: '天智大模型快捷登录',
    cosmoSectionDescLogin: '尚未登录天智云。请点击下方「登录」按钮完成 IAM 登录，插件会自动用工号换取 API Key 并配置模型。',
    cosmoSectionDescReady: '已通过 IAM 登录，插件已自动配置 API Key、Base URL 并选中默认模型。',
    cosmoStatusName: 'IAM 状态',
    cosmoStatusReady: '✅ 已登录，工号 {} — 插件已就绪',
    cosmoStatusNotReady: '⚠️ 未登录或未获取到工号（employee_code）',
    cosmoFetchKeySuccess: '✅ 天智大模型已自动配置完成（默认模型：{model}）',
    cosmoFetchKeyFailed: '❌ 天智大模型自动配置失败：{}',
